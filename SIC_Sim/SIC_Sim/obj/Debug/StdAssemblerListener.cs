...
public interface IStdAssemblerListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterDirResw([NotNull] StdAssemblerParser.DirReswContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>DirResw</c>
	/// labeled alternative in <see cref="StdAssemblerParser.directiva"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitDirResw([NotNull] StdAssemblerParser.DirReswContext context);
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterDirResb([NotNull] StdAssemblerParser.DirResbContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterEtiquetaFin([NotNull] StdAssemblerParser.EtiquetaFinContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="StdAssemblerParser.etiquetaFin"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitEtiquetaFin([NotNull] StdAssemblerParser.EtiquetaFinContext context);
}
} // namespace SIC_Sim
